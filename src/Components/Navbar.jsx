      ...
      >
        <div className="container-fluid">
          <a className="navbar-brand" href="#">
            <img src={image} alt="KFC" />

            <span>
              CART ( {totalItems} items / Rs {totalAmount} )
            </span>
          </a>

          <div>
            <form className="d-flex" role="search">
              <img src={bucketimg} alt="bucket" width="50" height="50" />
